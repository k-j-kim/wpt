...
class MockRuntime {
  ...
  _convertBlendModeToEnum(blendMode) {
    ...
    throw new TypeError("Unrecognized value for XREnvironmentBlendMode enum: " + blendMode);
  }
  ...
  _convertInteractionModeToEnum(interactionMode) {
    ...
    throw new TypeError("Unrecognized value for XRInteractionMode enum: " + interactionMode);
  }
